...
namespace Videoclub.Controllers
{
    public class AdministradorController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AdministradorId,Nombre")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AdministradorId,Nombre")] Administrador administrador)
        {
            if (ModelState.IsValid)
            {
